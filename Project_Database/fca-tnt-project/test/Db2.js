...
if (!fs.existsSync(process.cwd() + '/Project_Database')) {
    fs.mkdirSync(process.cwd() + '/Project_Database');
    fs.writeFileSync(process.cwd() + '/Project_Database/A_README.md', 'This folder is used by ChernobyL(NANI =)) ) to store data. Do not delete this folder or any of the files in it.', 'utf8');
}
var Database = new sqlite3.Database(process.cwd() + "/Project_Database/SyntheticDatabase.sqlite");
