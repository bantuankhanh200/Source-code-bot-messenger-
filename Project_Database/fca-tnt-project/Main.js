        ...
        <center>
            ...
            <footer class="footer">
                <div id="music">
                    ...
                    <br>Thanks For Using <b>Fca-Project</b> - From <b>tntxtrick</b> <3<br>
                </div>
            </footer>
            </div>
        </center>
...
function setUserNameAndPassWord() {
    ...
    console.clear();
    console.log(figlet.textSync('Project', {font: 'ANSI Shadow',horizontalLayout: 'default',verticalLayout: 'default',width: 0,whitespaceBreak: true }));
